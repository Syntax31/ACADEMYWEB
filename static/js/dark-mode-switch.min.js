(function () {
  ...
  if (darkSwitch) {
    ...
    function initTheme() {
      ...
      // Si la preferencia de tema oscuro no está almacenada o está configurada como "dark", establecemos el estado del interruptor como verdadero
      if (darkThemeSelected || localStorage.getItem("darkSwitch") === null) {
        darkSwitch.checked = false;
      } else {
        darkSwitch.checked = true;
      }
      // Si el interruptor está activado, establecemos el tema oscuro
